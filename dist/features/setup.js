        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _c.label = 1;
                case 1:
                    if (!(_i < modelNames_1.length)) return [3 /*break*/, 4];
                    modelName = modelNames_1[_i];
                    return [4 /*yield*/, generate_1.generate(root, dbRoot, migrationsRoot, modelName)];
                case 2:
                    _c.sent();
                    _c.label = 3;
                case 3:
                ...
                case 4:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, link_1.link(root, dbRoot, migrationsRoot, source, target, relationType)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                    ...
                    _c.label = 5;
                case 5:
                    if (!(_a < relationGraph_1.length)) return [3 /*break*/, 8];
                    _b = relationGraph_1[_a], source = _b[0], target = _b[1], _relationType = _b[2];
                    return [5 /*yield**/, _loop_1(source, target, _relationType)];
                case 6:
                    _c.sent();
                    _c.label = 7;
                case 7:
